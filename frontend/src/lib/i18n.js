...
const en = {
  ...
  cat_code_quality: 'code quality',
  cat_testing: 'testing',
  cat_debugging: 'debugging',
  cat_devops: 'devops & automation',
  cat_frontend_ui: 'frontend & UI',
  cat_data_docs: 'data & docs',
  cat_text_content: 'text & content',
  cat_research_analysis: 'research & analysis',
  cat_agent_workflow: 'agent workflow',
  cat_integration: 'integration & MCP',
  cat_other: 'other',
};
...
const zh = {
  ...
  cat_code_quality: '代码质量',
  cat_testing: '测试',
  cat_debugging: '调试',
  cat_devops: 'DevOps 与自动化',
  cat_frontend_ui: '前端与 UI',
  cat_data_docs: '数据与文档',
  cat_text_content: '文本与内容',
  cat_research_analysis: '研究与分析',
  cat_agent_workflow: 'Agent 工作流',
  cat_integration: '集成与 MCP',
  cat_other: '其他',
};
